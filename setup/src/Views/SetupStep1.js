...
export default class SetupStep1 extends React.Component {
    ...
    render(){
        return(
            ...
            <SplitedDivider text="or Customize" />
                ...
                <p>Choose a Table which contains your carbon neuraliztion strategies.</p>
                <Dropdown
                ...
                <p>Choose a Table to calculate your strategies' carbon footprint savings.</p>
                <Dropdown
                    className="dropdown-stories-styles_spacing carbon-dropdown"
                    onChange={()=>{}}
                    onClear={()=>{}}
